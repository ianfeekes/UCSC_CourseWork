/* DictionaryClient.c
 * Standardized test file for implementation of Dictionary.c hashing
 * Created by Ian Feekes December 12th 2017
 * Originally created by the UCSC CS department
 * This must be ran with a valid input file else it will cause a segmentation fault 
 */
